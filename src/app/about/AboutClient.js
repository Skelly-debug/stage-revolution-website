        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-neutral-300 text-lg">
            ...
            <p>
              ...
              ένα τραγούδι γεμάτο ένταση και μηνύματα – θα κυκλοφορήσει σε όλες
              τις ψηφιακές πλατφόρμες την 1η Δεκεμβρίου 2024.
            </p>

            <p>
              Οι ζωντανές εμφανίσεις αποτελούν τον πυρήνα τους. Έχουν
              συμμετάσχει σε μεγάλες διοργανώσεις όπως το 49ο και 50ό Φεστιβάλ
            ...
            <p className="font-semibold text-white">
              ...
              συναυλίες και να πραγματοποιήσουν το μεγάλο όνειρο του Στέφανου –
              να διοργανώσουν το δικό τους φεστιβάλ.
            </p>
          </div>
        </div>
      </div>
